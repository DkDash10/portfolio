        ...
        <div className="contact_section">
          <div className="contact_info">
            ...
            <div className="contact_box">
              ...
              <div>
                <h4>Email</h4>
                <span><a href="mailto:dhaneshdash11@gmail.com">dhaneshdash11@gmail.com</a></span>
              </div>
            </div>
            <div className="contact_box">
              ...
              <div>
                <h4>Linked In</h4>
                <span><a href="https://www.linkedin.com/in/dhanesh-09854922a/" target='_blank'>Profile</a></span>
              </div>
            </div>
          </div>
          <form action="https://formspree.io/f/xeoelgzq" method="POST" className='contact_form'>
