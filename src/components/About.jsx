    ...
    <section id="about">
      <div className="container">
        ...
        <div className="about_chat">
          <div className='separator'><span />08.06.2001<span /></div>
          <div className="chat_msg received">
            <label>🙃 ChatGPT</label>
            <div>
              <p>Hey there, my name is Dhaneshkumar Dash, a passionate and dedicated frontend developer with a flair for crafting immersive user experiences. With a strong foundation in React, HTML, CSS and JavaScript, I thrive on turning intricate designs into seamless, interactive websites. I believe in the power of clean code and responsive design to ensure that every user, on any device, can enjoy a smooth and engaging journey.</p>
              <span>04:55 AM</span>
            </div>
          </div>
          ...
          { showChat1 && (
            ...
            <div className="chat_msg received chat_first_msg" data-aos-delay="400" data-aos="fade-right">
              <label>🙃 Actually Me</label>
              <div>
                <p>Apart from my technical skills, some of my hobbies include playing online games, football enthusiast, chess and all the stuff related to music. YEAH.</p>
                <span>{chatTime}</span>
              </div>
            </div>
            <div className="chat_msg received chat_first_msg" data-aos-delay="400" data-aos="fade-right">
